...
# Initializing substitution_matrix - A bidimensional array to store the scores of the best global alignment where substitution_matrix[i][j] = score for optimal global alignment considering only first i characters of sequence 1 and first j characters of sequence 2
...
for i in range(1, len(seq1)+1):
    for j in range(1, len(seq2)+1):
        # Main Algortithm for filling Substitution Matrix in case of Global Alignment
